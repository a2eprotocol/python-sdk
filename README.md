...
- [Installation](codewiki/getting-started/installation.md) — Detailed setup instructions

### Architecture
- [Overview](codewiki/architecture/overview.md) — Three-layer design, system diagram, key patterns
- [Message Protocol](codewiki/architecture/message-protocol.md) — NDJSON wire format, message structure
- [Plugin System](codewiki/architecture/plugin-system.md) — Plugin lifecycle, registry, dispatch
- [Transport Layer](codewiki/architecture/transport-layer.md) — HTTP+SSE and DirectTransport
- [Session Management](codewiki/architecture/session-management.md) — Sessions, snapshots, restore

### SDK Reference
- [Client API](codewiki/sdk-reference/client-api.md) — `A2EClient`, `rpc()`, event streaming
- [Server API](codewiki/sdk-reference/server-api.md) — `A2EServer`, executor, plugin loading
- [Configuration](codewiki/sdk-reference/configuration.md) — `A2EHostConfig`, YAML reference
- [Audit System](codewiki/sdk-reference/audit.md) — `AuditEntry`, `AuditLog`, rotation
- [Persistence (Store)](codewiki/sdk-reference/store.md) — File and SQLite storage backends

### Capabilities
- [Tools](codewiki/capabilities/tools.md) — Named callable functions with JSON Schema I/O
- [Memory](codewiki/capabilities/memory.md) — Working, episodic, and semantic tiers
- [Environment](codewiki/capabilities/env.md) — RL environments: reset, step, observe
- [Processes](codewiki/capabilities/proc.md) — Subprocess spawning, I/O, signaling
- [Learning](codewiki/capabilities/learn.md) — Feedback, experience, adaptation
- [Skills](codewiki/capabilities/skills.md) — Named, versioned, sandboxed execution
- [Toolkits](codewiki/capabilities/toolkits.md) — Bundles of tools with shared config
...
- [Handshake](codewiki/protocol-spec/handshake.md) — Authentication and capability negotiation
...
- [Environment Agent Loop](codewiki/cookbook/env-agent-loop.md) — RL step loop patterns
- [Chain Pipeline](codewiki/cookbook/chain-pipeline.md) — Building DAG pipelines
- [MCP Integration](codewiki/cookbook/mcp-integration.md) — Connecting MCP servers
- [MCP Bridge (Plugin & Client)](codewiki/cookbook/mcp-bridge.md) — Full MCP bridge implementation
...
- [FAQ](codewiki/resources/faq.md) — Frequently asked questions
- [Security & Trust](codewiki/resources/security-trust.md) — Security model, hardening, threat model
- [Support](codewiki/resources/support.md) — Troubleshooting, debugging, contributing
- [Changelog](codewiki/resources/changelog.md) — Release history and upgrade guide

### Blog
- [The Harness Is the Product](codewiki/blog/2026-05-21-the-harness-is-the-product.md) — Why A2E breaks harness vendor lock-in and enables recursive self-learning
...
See [Support](codewiki/resources/support.md) for contribution guidelines.
