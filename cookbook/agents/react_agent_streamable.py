"""
react_agent_streamable.py — A2E React Agent
...
class RuntimeEventBus:
    """
    Local in-process event runtime.

    Responsibilities:
        - subscribe handlers
        - route typed events
        - wildcard namespaces
        - bridge SSE -> runtime events
    """
...
class EnvClient:
    ...
    def _handle_transport_message(
        ...
        """
        Converts streamed transport messages
        into typed runtime events.
        """
